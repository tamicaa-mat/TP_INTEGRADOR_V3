...
public class Prestamo {
	...
	public Prestamo(int idPrestamo, Cliente cliente, Cuenta cuentaAsociada, Date fechaAlta, double importePedido,
			int plazoMeses, double importePorMes, double interes, int cantidadCuotas, int estado) {
