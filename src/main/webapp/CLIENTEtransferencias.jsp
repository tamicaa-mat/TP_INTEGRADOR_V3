	...
	<main class="container py-5">
		<div class="transferencias-container">
			<div class="d-flex justify-content-between align-items-center mb-4">
				...
				<a href="TransferenciaServlet?action=mostrarFormulario"
					class="btn btn-primary">Realizar Transferencia</a>
			</div>
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						<c:forEach var="mov" items="${historialTransferencias}">
							<tr>
								<td class="fecha-hora">${mov.fechaHoraFormateada}</td>
								...
								<td><span
									class="${mov.getImporte() < 0 ? 'monto-negativo' : 'monto-positivo'}">
										<fmt:formatNumber value="${mov.getImporte()}" type="currency"
											currencySymbol="$ " />
								</span></td>
							</tr>
						</c:forEach>
