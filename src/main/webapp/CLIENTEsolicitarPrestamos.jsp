			...
			<div class="card shadow-sm">
				<div class="card-body">
					...
					<form action="SolicitarPrestamoServlet" method="post">
						<div class="mb-3">
							<label class="form-label small text-muted">Cuenta</label> <select
						...
						<div class="mb-3">
							<input type="number" class="form-control" id="importe"
								name="importe" placeholder="Importe solicitado" min="1000"
								required>
						</div>

						<div class="mb-3">
							<input type="number" class="form-control" id="plazo" name="plazo"
								placeholder="Plazo (en meses)" min="1" max="60" required>
						</div>

						<button type="submit"
							class="btn btn-secondary w-50 d-block mx-auto">Enviar
							solicitud</button>
				...
				<c:if test="${not empty mensajeError}">
					<div class="alert alert-danger text-center">❌ ${mensajeError}
					</div>
				</c:if>
