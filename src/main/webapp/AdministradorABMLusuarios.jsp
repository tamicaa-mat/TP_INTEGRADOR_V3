	...
	<main
		...
		<div class="col-md-4">
			<div class="card shadow">
				<div class="card-body">
					<h4 class="card-title text-center mb-4">Asignar Acceso a
						Cliente DNI: ${dniCliente}</h4>



					<form action="UsuarioServlet" method="post">
						<input type="hidden" name="action" value="crearUsuario"> <input
							type="hidden" name="dniCliente" value="${dniCliente}">

						<div class="mb-3">
							<input type="text" class="form-control" id="usuario"
								name="txtUsuario" placeholder="Usuario" required>
						</div>
						...
						<div class="mb-3">
							<input type="password" class="form-control" id="contrasena"
								name="txtContrasena" placeholder="Contrasena" required>
						</div>
